package br.com.fiap.postech.fastfood.pagamento.controller.metodopagamento;
...
public class MetodoPagamentoController implements MetodoPagamentoControllerSwagger {
  ...
  public ResponseEntity<Object> getAllMetodoPagamento(@RequestBody String cpf) {
    List<MetodoPagamento> metodoPagamentos = buscarMetodoPagamentoUseCase.findByCpf(cpf);
