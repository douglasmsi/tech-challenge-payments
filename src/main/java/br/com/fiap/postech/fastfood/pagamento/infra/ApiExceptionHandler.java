...
public class ApiExceptionHandler {
  ...
  private String createUrl(final HttpStatusCode httpStatusCode) {
    return switch (httpStatusCode.value()) {
      case 400 -> "https://api.pagamentos.com/errors/bad-request";
      case 404 -> "https://api.pagamentos.com/errors/not-found";
      case 500 -> "https://api.pagamentos.com/errors/internal-server-error";
      default -> "https://api.pagamentos.com/errors";
    };
  }
  ...
  public ProblemDetail handleHttpMessageNotReadableException() {
    return buildProblemDetail(
        new ResponseStatusException(HttpStatus.BAD_REQUEST, "Invalid JSON body"));
  }
}
