...
public interface MetodoPagamentoControllerSwagger {
    ...
    ResponseEntity<Object> getAllMetodoPagamento(@PathVariable String cpf);
    ...
    ResponseEntity<Object> getMetodoPagamentoById(@PathVariable Long id, @PathVariable String cpf);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Metodo Pagamento not found")})
    void deleteMetodoPagamentoById(@PathVariable Long id);
