...
public enum ErrorMessages {
  ...
  PEDIDO_STATUS_INVALID_TRANSITION_TO_PREPARATION_TO_CANCEL(
      "Transição de status inválida para preparação para cancelamento"),
  PEDIDO_STATUS_INVALID_TRANSITION_TO_PREPARATION_TO_CONFIRM(
      "Transição de status inválida para preparação para confirmação"),
  PEDIDO_STATUS_INVALID_TRANSITION_TO_PREPARATION_TO_DELIVER(
      "Transição de status inválida para preparação para entrega"),
  PEDIDO_STATUS_INVALID_TRANSITION_TO_PREPARATION_TO_FINISH(
      "Transição de status inválida para preparação para finalização"),
  PEDIDO_STATUS_INVALID_TRANSITION_TO_PREPARATION_TO_PREPARATION(
      "Transição de status inválida para preparação para preparação"),
  ...
  METODO_PAGAMENTO_NOT_FOUND("Método de pagamento não encontrado"), PAGAMENTO_INVALID_STATUS(
      "Status inválido para pagamento"),
